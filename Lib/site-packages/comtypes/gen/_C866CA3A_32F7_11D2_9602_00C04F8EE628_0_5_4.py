...
__all__ = [
    'ISpSerializeState', 'DISPID_SRGetRecognizers',
    'SECFEmulateResult', 'SPWAVEFORMATTYPE', 'tagSPTEXTSELECTIONINFO',
    'ISpeechDataKey', 'SVP_12', 'DISPID_SPIStartTime',
    ...
    'SpeechVisemeType', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFTADPCM_8kHzMono', 'SpeechSpecialTransitionType', 'SPCT_SLEEP',
    'ISpNotifySink', 'SPEI_RESERVED1', 'DISPID_SpeechAudioBufferInfo',
    'SP_VISEME_10', 'ISpeechPhraseRules', 'DISPID_SOTGetAttribute',
    'ISpeechMMSysAudio', 'DISPID_SpeechRecoResult2',
    'SpeechGrammarTagWildcard', 'DISPID_SRCEFalseRecognition',
    'DISPID_SOTRemove', 'SpeechCategoryAppLexicons',
    'SECLowConfidence', 'DISPID_SVSInputSentenceLength',
    'SPRST_ACTIVE_ALWAYS', 'SVESentenceBoundary', 'DISPID_SVResume',
    'SPEI_WORD_BOUNDARY', 'SPRS_INACTIVE', 'SAFT44kHz16BitMono',
    ...
    'SpeechTokenKeyUI', 'DISPID_SLPsCount', 'DISPID_SRGState',
    'ISpNotifySource', 'SPCT_SUB_DICTATION', 'SPWF_SRENGINE',
    'DISPID_SRRecognizer', 'SPEI_TTS_AUDIO_LEVEL', 'SPBO_AHEAD',
    'DISPID_SpeechObjectToken', 'SREStateChange', 'ISpObjectToken',
    'SpeechVoicePriority', 'SPRULESTATE', 'DISPID_SASetState',
    'DISPID_SPRs_NewEnum', 'SPWT_LEXICAL', 'SpeechGrammarState',
    'SVP_3', 'SPEI_VOICE_CHANGE', 'SPPS_Noncontent',
    'DISPID_SPEAudioSizeBytes', 'SPINTERFERENCE_TOOLOUD',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechObjectTokenCategory',
    'SAFT24kHz8BitStereo', 'DISPID_SRRSpeakAudio', 'SPAUDIOSTATE',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRSTType',
    'eLEXTYPE_PRIVATE11', 'SVF_Stressed', 'SAFT12kHz16BitMono',
    'DISPID_SMSAMMHandle', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPIRule',
    'DISPID_SRCEBookmark', 'DISPID_SLAddPronunciation',
    'DISPID_SRSNumberOfActiveRules', 'SPCONTEXTSTATE',
    'DISPID_SRCERecognition', 'SREPropertyStringChange',
    'SREAdaptation', 'eLEXTYPE_RESERVED9', 'SDKLDefaultLocation',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SRESoundEnd', 'SPEI_MAX_TTS', 'STCInprocServer',
    'DISPID_SGRSTsItem', 'SpeechRecoEvents', 'SGPronounciation',
    'ISpeechPhraseProperty', 'SPPHRASEELEMENT', 'SDTReplacement',
    'SVEEndInputStream', 'SPWORD', 'SPAUDIOBUFFERINFO',
    'DISPID_SVEPhoneme', 'SRAExport', 'SAFTCCITT_uLaw_44kHzMono',
    'SPDKL_DefaultLocation', 'DISPID_SLGetWords',
    'DISPID_SGRAddResource', 'DISPID_SpeechPhraseElement',
    'DISPID_SDKCreateKey', 'DISPID_SpeechPhraseAlternates',
    'SPXMLRESULTOPTIONS', 'SAFTGSM610_44kHzMono',
    'DISPID_SGRSTPropertyName', 'DISPID_SPEDisplayText',
    'DISPID_SPARecoResult', 'SPINTERFERENCE_NOISE',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SOTsCount',
    'SpShortcut', 'eLEXTYPE_PRIVATE20', 'DISPID_SASNonBlockingIO',
    'SPPS_RESERVED3', 'SPEI_SR_AUDIO_LEVEL', 'tagSPPROPERTYINFO',
    'SP_VISEME_12', 'SpeechStreamSeekPositionType',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechAudio', 'SpLexicon',
    'DISPID_SPRsCount', 'SpCompressedLexicon', 'SVPAlert',
    'ISpObjectTokenCategory', 'DISPID_SAVolume',
    'SpeechCategoryRecoProfiles', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SGRsCommitAndSave', 'DISPID_SpeechPhraseBuilder',
    'SVEViseme', 'DISPID_SVEEnginePrivate', 'DISPID_SFSOpen',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRCEEnginePrivate',
    'DISPID_SpeechLexiconProns', 'DISPID_SOTMatchesAttributes',
    'SPPS_Verb', 'SRCS_Enabled', 'SP_VISEME_7', 'SPSNoun',
    'SPBOOKMARKOPTIONS', 'SPVPRI_ALERT', 'DISPID_SGRsCommit',
    'SPAO_RETAIN_AUDIO', 'SPAR_High', 'ISpVoice',
    'SPSHT_NotOverriden', 'SPEI_RECO_STATE_CHANGE',
    'SPADAPTATIONRELEVANCE', 'DISPID_SVSkip', 'SREBookmark',
    'SPRS_ACTIVE', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SABIBufferSize', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRsDynamic', 'SPEI_END_SR_STREAM', 'DISPID_SPRuleName',
    'SAFTADPCM_11kHzMono', 'DISPID_SPEAudioStreamOffset',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRProfile',
    'DISPID_SRGRecoContext', 'DISPID_SGRSTransitions',
    'SPSNotOverriden', 'DISPID_SPIGrammarId', 'SPRST_NUM_STATES',
    'SAFT8kHz8BitMono', 'SPAUDIOSTATUS', 'SPINTERFERENCE_NOSIGNAL',
    'SRTSMLTimeout', 'SPSHT_OTHER', 'DISPID_SRIsShared',
    'DISPID_SDKSetStringValue', 'DISPID_SRGId', 'ISpeechVoiceStatus',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechPhraseRule',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechCustomStream',
    'DISPID_SVSPhonemeId', 'SPEVENT', 'SPWT_PRONUNCIATION',
    'SITooFast', 'IStream', 'SLODynamic', 'SPINTERFERENCE_TOOFAST',
    'SPINTERFERENCE', 'DISPID_SpeechPhraseElements', 'SPWORDTYPE',
    ...
    'SPPS_Unknown', 'SPSFunction', 'DISPID_SPPValue',
    'eWORDTYPE_ADDED', 'ISpeechLexiconWords',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRCCreateGrammar', 'SPVISEMES', 'DISPID_SMSADeviceId',
    'DISPID_SPEActualConfidence', 'SP_VISEME_9', 'SVP_16',
    'DISPID_SVPriority', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRRGetXMLErrorInfo',
    'SVP_11', 'SGRSTTRule', 'Speech_StreamPos_Asap',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVSLastResult',
    'SSTTDictation', 'SpeechTokenValueCLSID', 'SRAORetainAudio',
    'DISPID_SPPFirstElement', 'DISPID_SABIEventBias',
    'SPRECOGNIZERSTATUS', 'DISPID_SRGCmdLoadFromFile',
    'SpeechBookmarkOptions', 'DISPID_SAStatus', '_SPAUDIOSTATE',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_RESERVED4', 'SVP_8',
    'SRTExtendableParse', 'SREStreamStart', 'DISPID_SPCLangId',
    'ISpMMSysAudio', 'ISpRecognizer3', 'SDA_No_Trailing_Space',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_MAX_SR', 'SPPS_LMA',
    'DISPIDSPTSI_SelectionLength', 'SAFT24kHz8BitMono',
    'DISPID_SRCEStartStream', 'DISPID_SVSVisemeId', 'SPSSuppressWord',
    'SRTEmulated', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SWFEBitsPerSample', 'SVP_21', '__MIDL_IWinTypes_0009',
    'SREStreamEnd', 'SPEVENTENUM', 'eLEXTYPE_PRIVATE12',
    'SVSFNLPMask', 'Speech_Default_Weight', 'DISPID_SPRulesCount',
    'SpeechCategoryRecognizers', 'SGDisplay', 'ISpeechXMLRecoResult',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SBSWrite', 'SSTTTextBuffer',
    'DISPID_SpeechDataKey', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPRuleId', 'SpSharedRecoContext', 'SVP_9',
    'SDKLCurrentConfig', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechRecoContextEvents', 'SREFalseRecognition',
    'DISPID_SRCResume', 'DISPID_SMSSetData', 'DISPID_SVEViseme',
    'DISPID_SPEsCount', 'SAFTTrueSpeech_8kHz1BitMono', 'SREPrivate',
    'DISPID_SRCCmdMaxAlternates', 'SITooSlow',
    'ISpeechLexiconPronunciation', 'SVEAudioLevel',
    'SpeechTokenKeyFiles', 'SVP_14', 'SPGS_EXCLUSIVE',
    ...
    'DISPID_SRSSupportedLanguages', 'ISpeechAudioFormat', 'SPAR_Low',
    'SECFIgnoreCase', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SOTIsUISupported', 'DISPID_SPRuleFirstElement',
    'SpeechLoadOption', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRCRetainedAudioFormat', 'SVEVoiceChange',
    'SAFT48kHz8BitStereo', 'SRSEDone', 'DISPID_SVGetAudioInputs',
    'SAFT16kHz8BitMono', 'DISPID_SOTGetStorageFileName',
    'SPFM_CREATE', 'SAFT16kHz16BitMono', 'DISPID_SRState',
    'SpPhoneConverter', 'ISpeechTextSelectionInformation',
    'DISPID_SPEs_NewEnum', 'DISPIDSPTSI_ActiveOffset',
    'SDKLLocalMachine', 'SREPhraseStart', 'DISPID_SVSRunningState',
    'ISpStream', 'SpeechVisemeFeature', 'DISPID_SPPName',
    'SpeechPropertyNormalConfidenceThreshold', 'SRTAutopause',
    'ISpRecognizer2', 'DISPID_SpeechVoice', 'DISPID_SLPSymbolic',
    'DISPID_SRRAudio', 'SLTUser', 'LONG_PTR', 'SPPHRASEPROPERTY',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechRecoResult', 'SVF_None',
    'DISPID_SLGetPronunciations', 'SAFT8kHz16BitMono',
    'DISPID_SVEStreamStart', 'SPEI_RESERVED2', 'DISPID_SRCState',
    'SPPS_Function', 'Speech_Max_Pron_Length', 'eLEXTYPE_PRIVATE6',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SGRSTRule',
    'DISPID_SPIAudioStreamPosition', 'SPXRO_Alternates_SML',
    'SP_VISEME_16', 'DISPID_SPPChildren', 'SITooQuiet',
    'SREPropertyNumChange', 'SPDKL_LocalMachine', 'SRAImport',
    'SPEI_PHONEME', 'DISPID_SVSLastBookmarkId',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT22kHz8BitStereo',
    ...
    'SPSHORTCUTPAIR', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpPhraseInfoBuilder', 'SPCATEGORYTYPE',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPSHORTCUTPAIRLIST',
    'SpeechTokenKeyAttributes', 'SAFT11kHz8BitMono',
    'eWORDTYPE_DELETED', 'ISpeechRecoGrammar', 'SPEI_SOUND_START',
    'DISPID_SRCEHypothesis', 'SPFILEMODE', 'DISPID_SBSRead',
    'DISPID_SLPsItem', 'DISPID_SOTCGetDataKey', 'tagSTATSTG',
    ...
    'SASClosed', 'SREAudioLevel', 'ISpProperties',
    'DISPID_SpeechPhraseAlternate', 'SPSERIALIZEDPHRASE',
    'SpeechPropertyAdaptationOn', 'SGRSTTEpsilon',
    'DISPID_SGRSTWeight', 'DISPID_SFSClose', 'ISpRecognizer',
    'SSFMCreateForWrite', 'SpStreamFormatConverter',
    'DISPID_SRCBookmark', 'DISPID_SVSCurrentStreamNumber',
    'SPLO_STATIC', 'DISPID_SPAsCount', 'SAFT32kHz8BitMono',
    ...
    'DISPID_SGRSTText', 'DISPID_SLWs_NewEnum', 'ISpRecoContext',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCVoice',
    'SAFT48kHz16BitStereo', 'SVP_5', 'eLEXTYPE_PRIVATE14',
    'SpeechAddRemoveWord', 'SP_VISEME_6', 'SPGRAMMARSTATE',
    'SPEI_RESERVED3', 'SpeechVoiceSkipTypeSentence',
    ...
    'SAFT24kHz16BitStereo', 'SPEI_MIN_SR', 'SP_VISEME_18',
    'DISPID_SWFEBlockAlign', 'SPRULE', 'SPAS_CLOSED',
    'SAFT32kHz8BitStereo', 'DISPID_SGRSTPropertyValue', 'SVSFIsXML',
    'DISPID_SRCEEndStream', 'STSF_CommonAppData',
    'DISPID_SDKEnumValues', 'SPSLMA', 'SPSTREAMFORMATTYPE',
    'DISPID_SRCESoundStart', 'SBONone', 'DISPID_SOTCategory',
    'SVP_10', 'DISPID_SDKGetBinaryValue', 'SPCT_COMMAND',
    'SPBO_TIME_UNITS', 'SpeechPropertyResponseSpeed',
    ...
    'DISPID_SVVolume', 'SITooLoud', 'WAVEFORMATEX',
    ...
    'SPAS_STOP', 'SPSEMANTICERRORINFO', 'DISPID_SpeechBaseStream',
    'DISPID_SWFEChannels', 'SDTAll', 'SPEI_HYPOTHESIS',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRSTNextState', 'SPBO_NONE',
    'SGSExclusive', 'SRATopLevel', 'DISPID_SGRsItem', 'SPVPRI_OVER',
    'IEnumSpObjectTokens', 'DISPID_SRCEventInterests',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRRSetTextFeedback',
    'SPPHRASERULE', 'SpeechCategoryAudioOut',
    'DISPID_SOTGetDescription', 'ISpLexicon',
    'DISPID_SpeechAudioFormat', 'SPPS_NotOverriden',
    'SpeechCategoryAudioIn', 'SPGRAMMARWORDTYPE',
    'SAFTNoAssignedFormat', 'SECFNoSpecialChars',
    'SAFTADPCM_22kHzStereo', 'ISpeechAudio', 'SpeechLexiconType',
    'SINoSignal', 'SPLO_DYNAMIC', 'DISPID_SRStatus', 'SPLEXICONTYPE',
    'SpeechPartOfSpeech', 'DISPID_SPPEngineConfidence',
    'STSF_FlagCreate', 'DISPID_SVAudioOutput',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE18',
    'SAFT12kHz8BitStereo', 'SPSInterjection', 'SPCT_DICTATION',
    'DISPID_SVRate', 'DISPID_SPRsItem', 'DISPID_SOTCId',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCPause', 'DISPID_SPRuleEngineConfidence', 'SPXRO_SML',
    'SpeechCategoryPhoneConverters',
    'DISPID_SpeechGrammarRuleStateTransition', 'SGSEnabled',
    'DISPID_SPRNumberOfElements', 'eLEXTYPE_PRIVATE19',
    'ISpRecoGrammar2', 'SpeechWordType', 'SVSFIsNotXML', 'SVP_1',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SAEventHandle',
    'DISPID_SBSSeek', 'SpeechRecognizerState', 'UINT_PTR',
    'SPSMF_SAPI_PROPERTIES', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SABIMinNotification', 'SPPS_RESERVED4',
    'SpeechVoiceSpeakFlags', 'DISPID_SpeechLexiconPronunciation',
    'SAFT8kHz8BitStereo', 'DISPID_SPPId', 'SGLexical',
    'SAFT16kHz8BitStereo', 'SRAInterpreter',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCEPhraseStart',
    'SPEI_SOUND_END', 'DISPID_SPRText', 'SAFT22kHz8BitMono',
    'SDTAlternates', 'DISPID_SPPParent', 'SGSDisabled',
    'SpMMAudioEnum', 'STSF_AppData', 'SDA_Consume_Leading_Spaces',
    'SINoise', 'SREInterference', 'ISpEventSource', 'SAFTDefault',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SLPs_NewEnum',
    'ISpeechPhraseInfo', 'SRESoundStart', 'ISpStreamFormat',
    'SPSHORTCUTTYPE', 'SBOPause', 'DISPID_SVVoice',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechAudioStatus',
    'SPINTERFERENCE_NONE', 'SpNotifyTranslator', 'SVSFUnusedFlags',
    'SpCustomStream', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPIReplacements', 'ISpeechObjectTokenCategory', 'SpVoice',
    ...
    'Speech_Max_Word_Length', 'SVEWordBoundary', 'SDTLexicalForm',
    'SVSFParseSsml', 'SpeechTokenShellFolder', 'DISPID_SRGetFormat',
    'ISpeechRecognizer', 'ISpeechRecognizerStatus',
    'DISPID_SPRuleConfidence', 'SPEI_START_INPUT_STREAM',
    'SPEI_RECO_OTHER_CONTEXT', 'SPPS_RESERVED1', 'SVSFPersistXML',
    'ISpeechPhraseInfoBuilder', 'SWPKnownWordPronounceable',
    'ISpXMLRecoResult', 'DISPID_SpeechGrammarRules',
    'SDA_Two_Trailing_Spaces', 'DISPID_SOTCSetId', 'SPSHT_Unknown',
    'SpSharedRecognizer', 'eLEXTYPE_APP', 'SAFTGSM610_22kHzMono',
    'SpMemoryStream', 'DISPID_SVSInputWordLength', 'DISPID_SPAsItem',
    ...
    'STSF_LocalAppData', 'SP_VISEME_5', 'eLEXTYPE_PRIVATE7',
    'SECHighConfidence', 'SVSFNLPSpeakPunc', 'DISPID_SRRTStreamTime',
    'ISpeechPhraseAlternate', 'DISPID_SDKDeleteValue',
    'SPEI_END_INPUT_STREAM', 'SPWF_INPUT', 'SAFT32kHz16BitStereo',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechRecoContext',
    'DISPID_SADefaultFormat', 'eLEXTYPE_PRIVATE2',
    'SpUnCompressedLexicon', 'SAFT32kHz16BitMono',
    'DISPID_SpeechFileStream', 'DISPID_SRGRules',
    'DISPID_SDKSetBinaryValue', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPRFirstElement', 'SPSEMANTICFORMAT', 'SPEI_SR_BOOKMARK',
    'ISpeechPhraseElements', 'DISPID_SRIsUISupported',
    'DISPID_SpeechPhraseRule', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SASState',
    'DISPID_SWFESamplesPerSec', 'ISpAudio',
    ...
    'DISPID_SVSInputSentencePosition', 'SpFileStream',
    'IInternetSecurityMgrSite', 'ISpRecoGrammar', 'DISPID_SMSALineId',
    'SPWORDPRONUNCIATIONLIST', '_ISpeechRecoContextEvents',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVSpeakStream',
    'DISPID_SVEStreamEnd', 'eLEXTYPE_PRIVATE9',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_13', 'SP_VISEME_15',
    'DISPID_SPISaveToMemory', 'SPCS_ENABLED', 'SPPROPERTYINFO',
    'SPVPRI_NORMAL', 'DISPID_SRGIsPronounceable', 'SASStop',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPFM_OPEN_READONLY',
    'DISPID_SPELexicalForm', 'DISPID_SVIsUISupported',
    'DISPID_SPEsItem', 'ISpeechCustomStream', 'DISPID_SRCESoundEnd',
    'SINone', 'SSFMOpenForRead', 'SDTRule',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRGCmdSetRuleState', 'SPEI_RECOGNITION', 'SPLOADOPTIONS',
    'ISpPhoneConverter', 'SDTAudio', 'SpNullPhoneConverter',
    'DISPID_SpeechLexiconWords', 'DISPID_SpeechPhoneConverter',
    'Speech_StreamPos_RealTime', 'SVSFPurgeBeforeSpeak', 'SPAO_NONE',
    'SpeechRecognitionType', 'DISPID_SVAlertBoundary',
    'DISPID_SRCEAdaptation', 'SVP_20', 'SAFT48kHz8BitMono',
    'SAFTADPCM_44kHzMono', 'SpeechInterference', 'SVSFParseMask',
    'SPWORDLIST', 'SAFT44kHz8BitMono', 'DISPID_SRRSaveToMemory',
    'DISPID_SVDisplayUI', 'DISPID_SRRRecoContext', 'DISPID_SGRClear',
    'SVSFParseSapi', 'SP_VISEME_3', 'SPCS_DISABLED',
    'eLEXTYPE_PRIVATE17', 'SpeechRetainedAudioOptions',
    'STCInprocHandler', 'SpAudioFormat',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRId',
    'SSSPTRelativeToEnd', 'SpeechRuleState', 'SPDKL_CurrentUser',
    'DISPID_SpeechVoiceEvent', 'SPPHRASE', 'SPEVENTSOURCEINFO',
    'SpeechPropertyResourceUsage', 'DISPID_SRRGetXMLResult',
    'SpeechRecoProfileProperties', 'DISPID_SPPsCount',
    'SPEI_RESERVED5', 'DISPID_SLWPronunciations', 'SVP_19',
    'SAFT48kHz16BitMono', 'SVP_18', 'eLEXTYPE_PRIVATE16',
    'IInternetSecurityManager', 'DISPIDSPTSI_SelectionOffset',
    'SpTextSelectionInformation', 'DISPID_SGRsCount',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechRecoResultDispatch',
    'SGLexicalNoSpecialChars', 'SAFTCCITT_ALaw_11kHzMono',
    'SRTStandard', 'SRERequestUI', 'DISPID_SPIGetText',
    'ISpeechBaseStream', 'DISPID_SRAudioInputStream',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechObjectTokens', 'SECFIgnoreKanaType',
    'SGRSTTDictation', 'DISPID_SRGetPropertyString',
    'DISPID_SLGetGenerationChange', 'SWPUnknownWordPronounceable',
    'SWTDeleted', 'DISPID_SRRTTickCount', 'SPGS_ENABLED',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPAStartElementInResult',
    'SVSFlagsAsync', 'DISPID_SRCRecognizer',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechGrammarRule',
    'SPAR_Medium', 'DISPID_SRRPhraseInfo', 'SpeechAllElements',
    'STCRemoteServer', 'SVSFVoiceMask', 'eLEXTYPE_RESERVED8',
    'ISpShortcut', 'DISPID_SPEPronunciation', 'SECFDefault',
    'SRADynamic', 'SpeechGrammarWordType', 'SP_VISEME_19',
    'eLEXTYPE_PRIVATE8', 'SAFT16kHz16BitStereo',
    'DISPID_SOTs_NewEnum', 'DISPID_SLWLangId', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPACommit', 'DISPID_SPIAudioSizeTime',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRGCommit',
    'DISPID_SpeechXMLRecoResult', 'SPEI_VISEME',
    'ISpeechGrammarRuleStateTransitions', 'SAFT22kHz16BitMono',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SOTSetId', 'SAFTText',
    'SRADefaultToActive', 'DISPID_SRSCurrentStreamNumber',
    'SVPNormal', 'DISPID_SRGSetTextSelection', 'SPRECOSTATE',
    'DISPID_SPILanguageId', 'SAFTGSM610_8kHzMono',
    'DISPID_SPPNumberOfElements', 'SECFIgnoreWidth', 'SSFMCreate',
    'ISpEventSink', 'SPFM_CREATE_ALWAYS', 'DISPID_SVEventInterests',
    'SPEI_SR_PRIVATE', 'SpeechEngineProperties', 'DISPID_SVStatus',
    'SVP_13', 'ISpeechAudioBufferInfo', 'DISPID_SGRsFindRule',
    'SpeechRuleAttributes', 'DISPID_SLPLangId',
    'DISPID_SPPConfidence', 'DISPID_SGRSRule', 'ISpResourceManager',
    'ISpeechLexiconWord', 'ISpeechPhoneConverter',
    'DISPID_SRCRetainedAudio', 'SREHypothesis',
    'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_1',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpObjectTokenCategory',
    'DISPID_SVESentenceBoundary', 'DISPID_SDKGetlongValue',
    'SP_VISEME_0', 'DISPID_SpeechPhraseInfo',
    'SpeechPropertyHighConfidenceThreshold', 'ISpDataKey',
    'DISPID_SRCRequestedUIType', 'ISpeechObjectToken',
    'ISequentialStream', 'DISPID_SVWaitUntilDone', 'SPVOICESTATUS',
    'eLEXTYPE_PRIVATE10', 'SpeechVoiceEvents', 'DISPID_SGRsAdd',
    'SpeechStreamFileMode', 'DISPID_SRGDictationUnload', 'SPBO_PAUSE',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPIDSPRG', 'SPCT_SUB_COMMAND',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRs_NewEnum', 'SRAONone',
    'eLEXTYPE_PRIVATE13', 'SLOStatic', 'SP_VISEME_8',
    'DISPID_SPRuleParent', 'SRSInactiveWithPurge',
    'DISPID_SGRInitialState', 'SVP_2', 'SVPOver',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SGRSTsCount',
    'SpeechTokenContext', 'ISpeechVoice', 'DISPID_SDKDeleteKey',
    'DISPID_SPCIdToPhone', 'ISpRecoContext2', 'SPPS_SuppressWord',
    'ISpStreamFormatConverter', 'DISPID_SRRTOffsetFromStart',
    'SLTApp', 'SVEPrivate', 'SpeechAudioState',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechPhraseReplacements', 'SPSVerb',
    'SASRun', 'SVSFIsFilename', 'SPVPRIORITY',
    'DISPID_SPERequiredConfidence', 'ISpRecoResult',
    'SPRECORESULTTIMES', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRGReset', 'SAFTADPCM_8kHzStereo', 'SVEAllEvents',
    'SPAS_PAUSE', 'SDKLCurrentUser', 'SVP_17',
    'DISPID_SPEDisplayAttributes', 'SAFTADPCM_22kHzMono',
    'DISPID_SPPs_NewEnum', 'SPEI_RESERVED6',
    'DISPID_SLRemovePronunciation', 'SDA_One_Trailing_Space',
    'ISpeechGrammarRuleState', 'ISpPhrase', 'DISPID_SBSFormat',
    'DISPID_SRSAudioStatus', 'SPRST_INACTIVE',
    'DISPID_SRCVoicePurgeEvent', 'SVEStartInputStream',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRAudioInput', 'SpMMAudioIn',
    'DISPID_SGRSAddSpecialTransition', 'SVP_15',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpWaveFormatEx', 'DISPID_SAFGuid',
    'SPBINARYGRAMMAR', 'SAFT11kHz8BitStereo', 'eLEXTYPE_RESERVED7',
    'SPWT_DISPLAY', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SREmulateRecognition', 'SpeechAudioFormatGUIDWave',
    'eLEXTYPE_USER', 'SAFT44kHz8BitStereo', 'DISPID_SpeechMMSysAudio',
    'SP_VISEME_11', 'SpeechMicTraining', 'DISPID_SRRAudioFormat',
    'ISpeechObjectTokens', 'DISPID_SVGetVoices', 'SVF_Emphasis',
    'SpeechAudioProperties', 'SpStream', 'SPSMF_UPS',
    'DISPID_SVGetProfiles', 'SpeechTokenIdUserLexicon',
    'ISpeechRecoResult2', 'SPWORDPRONUNCIATION', 'DISPID_SLWWord',
    'SPSModifier', 'SpeechDictationTopicSpelling', 'SPPS_RESERVED2',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRName', 'SGRSTTWord',
    'SpMMAudioOut', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPIAudioSizeBytes', 'SPEI_SR_RETAINEDAUDIO',
    'SGDSActiveUserDelimited', 'DISPID_SOTDataKey', 'SPEI_UNDEFINED',
    'DISPID_SVEWord', 'SPRST_ACTIVE', 'SRSEIsSpeaking',
    'DISPID_SDKEnumKeys', 'SVP_7', 'SPPS_Noun', 'ISpeechGrammarRules',
    'DISPID_SWFEFormatTag', 'ISpeechRecoContext',
    'DISPID_SLGenerationId', 'SAFTNonStandardFormat',
    'DISPID_SVEBookmark', 'SpObjectToken', 'SSTTWildcard',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRERecoOtherContext',
    'SpeechRunState', 'DISPID_SVEAudioLevel', 'SpeechDiscardType',
    'SPGS_DISABLED', 'ISpeechWaveFormatEx', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRAddState', 'DISPID_SOTCDefault', 'ISpObjectWithToken',
    'DISPID_SRSetPropertyString', 'SREAllEvents', 'SPFM_NUM_MODES',
    'SRSInactive', 'DISPID_SVPause', 'DISPIDSPTSI', 'SPAR_Unknown',
    'DISPID_SVSpeak', 'DISPID_SpeechWaveFormatEx',
    'ISpeechPhraseReplacement', 'SRSActiveAlways', 'SPSUnknown',
    'DISPID_SOTId', 'SpResourceManager', 'IEnumString',
    'DISPID_SASCurrentDevicePosition', 'SP_VISEME_4',
    'DISPID_SPEAudioSizeTime', 'DISPID_SWFEExtraData', 'SWTAdded',
    'DISPID_SOTDisplayUI', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechGrammarRuleState', 'ISpPhraseAlt', 'SRERecognition',
    'ISpPhoneticAlphabetSelection', 'ISpeechMemoryStream', 'SVP_0',
    'SDTProperty', 'SPEI_REQUEST_UI', 'SPPHRASEREPLACEMENT',
    'SRSActive', 'SVP_6', 'DISPID_SDKSetLongValue',
    'DISPID_SASCurrentSeekPosition', 'SPFM_OPEN_READWRITE',
    'SP_VISEME_17', 'DISPID_SpeechLexicon', 'SP_VISEME_14',
    'DISPID_SPAPhraseInfo', 'eLEXTYPE_RESERVED10', 'STCAll',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_ADAPTATION',
    'DISPID_SGRSTPropertyId', 'ISpRecoCategory', 'ISpeechFileStream',
    'ISpGrammarBuilder', 'DISPID_SLPType', 'DISPID_SRCERequestUI',
    'DISPID_SPRulesItem', 'SFTInput', 'DISPID_SpeechRecoResult',
    'DISPID_SLWType', 'SECNormalConfidence', 'SRARoot',
    'ISpeechPhraseProperties', 'SGRSTTTextBuffer',
    'DISPID_SPANumberOfElementsInResult',
    'SpeechVoiceCategoryTTSRate', 'SPAS_RUN',
    'DISPID_SRGDictationLoad', 'SVP_4', 'SpeechRecoContextState',
    'DISPID_SLWsCount', 'DISPID_SOTCreateInstance',
    'SpeechEngineConfidence', 'SVEPhoneme', 'SPEI_MIN_TTS',
    'ISpeechRecoResultTimes', 'DISPID_SAFType', 'DISPID_SDKOpenKey',
    'SGDSActiveWithAutoPause', 'SP_VISEME_20',
    'DISPID_SRCEAudioLevel', 'SAFT12kHz8BitMono',
    'SpeechGrammarTagDictation', '_RemotableHandle', 'SRTReSent',
    'ISpeechResourceLoader', 'DISPID_SPIElements', 'DISPID_SLWsItem',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechEmulationCompareFlags',
    'SGDSActive', 'DISPID_SRDisplayUI', 'DISPID_SPIEngineId',
    'SPSHT_EMAIL', 'ISpNotifyTranslator', 'SPRECOCONTEXTSTATUS',
    'SDTDisplayText', 'SPDKL_CurrentConfig', 'SPEI_PHRASE_START',
    'SASPause', 'SP_VISEME_2', 'SVSFDefault', 'SpeechAudioVolume',
    'SpeechWordPronounceable', 'eLEXTYPE_RESERVED6', 'SPAUDIOOPTIONS',
    'SAFT11kHz16BitMono', 'SP_VISEME_21',
